...
```
$ rffilter.py -g butterworth -nodal -f 10e6 -bw 400e3 -n 5 -qu 200 | tee examples/nodalloss.cir
.SUBCKT F1 1 5
...
```
$ rffilter.py -k chebyshev_0.5 -bw 2500 -n 8 -l 70e-3 -crystal -cp 3.7e-12 -f 5000.680e3,5000.123e3,4999.670e3,5000.235e3,5000.320e3,4999.895e3,5000.010e3,5000.485e3 | tee examples/multiple.cir
.SUBCKT F1 1 25
