...
N g0   g1 ... gn    rs
    ...
    [ 1.0000,0.3827,1.0824,1.5772,1.5307,inf ], # 4
    [ 1.0000,0.3090,0.8944,1.3820,1.6944,1.5451,inf ], # 5
    [ 1.0000,0.2588,0.7579,1.2016,1.5529,1.7593,1.5529,inf ], # 6
    [ 1.0000,0.2225,0.6560,1.0550,1.3972,1.6588,1.7988,1.5576,inf ], # 7
    [ 1.0000,0.1951,0.5776,0.9371,1.2588,1.5283,1.7287,1.8246,1.5607,inf ], # 8
    [ 1.0000,0.1736,0.5155,0.8414,1.1408,1.4037,1.6202,1.7772,1.8424,1.5628,inf ], # 9
    [ 1.0000,0.1564,0.4654,0.7626,1.0406,1.2921,1.5100,1.6869,1.8121,1.8552,1.5643,inf ], # 10

N q1 qn k12 k23 k34 k45 k56 ...
    [ 1.0000,inf ], # 1
    [ 0.7071,0.0000,1.0000 ], # 2
    [ 0.5000,inf,1.2247,0.7071 ], # 3
    [ 0.3827,0.0000,1.5538,0.7654,0.6436 ], # 4
    [ 0.3090,inf,1.9021,0.8995,0.6535,0.6180 ], # 5
    [ 0.2588,0.0000,2.2579,1.0479,0.7321,0.6050,0.6050 ], # 6
    [ 0.2225,inf,2.6174,1.2021,0.8237,0.6569,0.5789,0.5974 ], # 7
    [ 0.1951,0.0000,2.9791,1.3593,0.9207,0.7210,0.6152,0.5631,0.5926 ], # 8
    [ 0.1736,inf,3.3422,1.5184,1.0207,0.7902,0.6631,0.5893,0.5526,0.5893 ], # 9
    [ 0.1564,0.0000,3.7062,1.6786,1.1225,0.8624,0.7159,0.6266,0.5720,0.5454,0.5870 ], # 10
```
