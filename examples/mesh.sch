...
<Components>
  ...
  <.SP SP1 1 60 160 0 65 0 0 "lin" 1 "9.6M" 1 "10.4M" 1 "201" 1 "no" 0 "1" 0 "2" 0 "no" 0 "no" 0>
  ...
  <Eqn Eqn1 5 960 110 -31 17 0 0 "phi21=unwrap(angle(S[1,1]))" 1 "phase=rad2deg(angle(S[1,1]))" 1 "delay=-diff(phi21,2*pi*frequency)" 1 "yes" 0>
</Components>
<Wires>
...
<Diagrams>
  <Rect 300 777 577 477 3 #c0c0c0 1 00 1 9.6e+06 100000 1.04e+07 1 -0.0999827 0.2 1.1 1 -1 0.2 1 315 0 225 "" "" "" "">
