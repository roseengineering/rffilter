...
<Components>
  ...
  <.SP SP1 1 60 160 0 65 0 0 "lin" 1 "5.000M" 1 "5.00325M" 1 "401" 1 "no" 0 "1" 0 "2" 0 "no" 0 "no" 0>
  ...
  <Eqn Eqn1 5 920 160 -31 17 0 0 "phi21=unwrap(angle(S[1,1]))" 1 "phase=rad2deg(angle(S[1,1]))" 1 "delay=-diff(phi21,2*pi*frequency)" 1 "yes" 0>
</Components>
<Wires>
...
<Diagrams>
  <Rect 300 777 577 477 3 #c0c0c0 1 00 1 5e+06 500 5.0035e+06 1 -0.0979225 0.2 1.09981 1 -1 0.2 1 315 0 225 "" "" "" "">
