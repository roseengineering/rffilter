...
<Properties>
  <View=0,41,1211,907,1,0,0>
  <Grid=10,10,1>
  <DataSet=qexlow.dat>
  <DataDisplay=qexlow.dpl>
  <OpenDisplay=0>
  <Script=qexlow.m>
  <RunScript=0>
  <showFrame=0>
...
<Components>
  ...
  <SPICE X1 1 580 120 -26 -57 0 0 "/home/george/share/github-rffilter/examples/qexlow.cir" 1 "_net1,_net37" 0 "yes" 0 "none" 0>
...
<Diagrams>
  <Rect 300 777 577 477 3 #c0c0c0 1 00 1 8e+06 500 8.0035e+06 1 -0.128008 0.2 1.10255 1 -1 0.2 1 315 0 225 "" "" "" "">
