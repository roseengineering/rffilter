...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=xtalnone.dat>
  <DataDisplay=xtalnone.dpl>
  <OpenDisplay=0>
  <Script=xtalnone.m>
  <RunScript=0>
  <showFrame=0>
...
<Components>
  ...
  <.AC AC1 1 60 350 0 40 0 0 "lin" 1 "2.5M" 1 "10M" 1 "101" 1 "no" 0>
  ...
  <SPICE X1 1 580 120 -26 -57 0 0 "xtalnone.cir" 1 "_net1,_net25" 0 "yes" 0 "none" 0>
